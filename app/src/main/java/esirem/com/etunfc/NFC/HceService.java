...
//faire hériter de HostApduService, ce qui va permettre à notre classe de devenir un service HCE
public class HceService extends HostApduService {
    ...
    //définition des échanges (au format APDU - Application Protocol Data Unit) entre un lecteur et notre application.
    @Override
